	...
	<div class="row">
		<div class="col-md-2 offset-1 pt-5 text-right">
			<ul class="navbar-nav sidebar-menu menu">
				<p class="text-left" style="font-weight: bold">Categories</p>
				@foreach ($categories as $menu)
					<li class="link border border-primary p-1 m-1 bg-primary">
						<a class="text-light" href="{{ route('page.category',['id'=>$menu->id]) }}" class="link">
							{{ $menu->name }}
						</a> 
					</li>
				@endforeach
				...
				@else
					@foreach ($category->posts as $post)
						<div class="col-md-12">
							...
							<i><a href="{{ route('singlePost',['id'=>$post->id]) }}" class="text-primary">Xem thêm. . .</a></i>
